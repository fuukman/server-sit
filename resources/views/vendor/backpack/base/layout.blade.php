...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-lg">Admin Panel Server</span>
        </a>
      ...
      <footer class="main-footer">
        @if (config('backpack.base.show_powered_by'))
            <div class="pull-right hidden-xs">
              <a target="_blank" href="http://laravelbackpack.com"></a>
            </div>
        @endif
    ...
    <!-- <script src="http://tarruda.github.io/bootstrap-datetimepicker/assets/js/bootstrap-datetimepicker.pt-BR.js"></script> -->
